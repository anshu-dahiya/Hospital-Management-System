...
public class Edit_Patient extends JFrame implements ActionListener {
    ...
    Edit_Patient(String username) {
        ...
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("Hospital/HMS icons/16.jpg"));
        Image i1 = img.getImage().getScaledInstance(900, 600, Image.SCALE_SMOOTH);
        ImageIcon img1 = new ImageIcon(i1);
        l1.setIcon(img1);

        l2 = new JLabel("Edit Patient Details");
    ...
    private void loadPatientDetails() {
        try {
            ...
            if (rs.next()) {
                ...
                t12.setText(rs.getString("father_name"));
                t13.setText(rs.getString("marital_status"));
                t14.setText(rs.getString("symptoms"));
            }
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == bt1) {
            ...
            String father_name = t12.getText();
            String marital_status = t13.getText();
            String symptoms = t14.getText();

            try {
                ConnectionClassHMS obj = new ConnectionClassHMS();
                String q = "update patient set name='" + name + "', password='" + password + "', dob='" + dob + "', address='" + address + "', phone='" + phone + "', email='" + email + "', city='" + city + "', gender='" + gender + "', blood='" + blood + "', age='" + age + "', father_name='" + father_name + "', marital_status='" + marital_status + "', symptoms='" + symptoms + "' where username='" + username + "'";
    ...
    public static void main(String[] args) {
        new Edit_Patient("username_to_edit");
    }
}
