...
public class Edit_Receptionist extends JFrame implements ActionListener {
    ...
    Edit_Receptionist(String username) {
        ...
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("Hospital/HMS icons/30.jpg"));
        ...
        try {
            ...
            if (rs.next()) {
                ...
                t12.setText(rs.getString("joining_date"));
                t13.setText(rs.getString("qualification"));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == bt1) {
            ...
            try {
                ConnectionClassHMS obj = new ConnectionClassHMS();
                String q = "update receptionist set name='"+name+"', password='"+password+"', dob='"+dob+"', address='"+address+"', phone='"+phone+"', email='"+email+"', city='"+city+"', gender='"+gender+"', blood='"+blood+"', age='"+age+"', joining_date='"+joining_date+"', qualification='"+qualification+"' where username='"+username+"'";
                obj.stm.executeUpdate(q);
                JOptionPane.showMessageDialog(null, "Receptionist Details Updated Successfully");
                f.setVisible(false);
            } catch (Exception ex) {
                ex.printStackTrace();
            }
    ...
    public static void main(String[] args) {
        new Edit_Receptionist("receptionist_username"); // Replace with the actual username you want to edit
    }
}
