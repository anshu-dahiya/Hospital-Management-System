...
public class Add_Patient extends JFrame implements ActionListener {
    ...
    Add_Patient() {
        ...
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("Hospital/HMS icons/15.jpg"));
        ...
        l14.setBounds(450, 400, 150, 25);
        l14.setFont(new Font("Arial", Font.BOLD, 20));
        l14.setForeground(Color.BLACK);
        l1.add(l14);

        t12 = new JTextField();
        t12.setBounds(600, 400, 150, 25);
        l1.add(t12);
        ...
        l16.setBounds(450, 450, 140, 25);
        l16.setFont(new Font("Arial", Font.BOLD, 20));
        l16.setForeground(Color.BLACK);
        l1.add(l16);

        t14 = new JTextField();
        t14.setBounds(600, 450, 150, 25);
        l1.add(t14);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == bt1) {
            ...
            try {
                ...
                String q = "insert into patient(name, username, password, dob, address, phone, email, city, gender, blood, age, father_name, marital_status, symptoms) values('"
                        + name + "','" + username + "','" + password + "','" + dob + "','" + address + "','" + phone + "','" + email + "','" + city + "','" + gender + "','" + blood + "','" + age + "','" + father_name + "','" + marital_status + "','" + symptoms + "')";
